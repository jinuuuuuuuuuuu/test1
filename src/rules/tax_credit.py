...
def calculate_tax_credit(
    ...
    # 합산 900만원 한도뿐 아니라 연금저축 단독 600만원 한도 때문에 제외된 금액도 포함해야 한다.
    # 예: 연금저축만 700만원 납입하면 세액공제 대상은 600만원, 제외액은 100만원이다
    # (기존에는 total_paid - COMBINED_CREDIT_LIMIT만 써서 이 케이스가 0으로 잘못 나왔다).
