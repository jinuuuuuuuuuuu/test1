...
- 자동매수: 기존가입자 = 만기일 + 4주 뒤(만기일+29일) 통지 → 통지 + 2주 뒤(통지일+15일) 대기 → 자동매수
            신규가입자 = 최초 부담금 납입 다음 영업일 통지 → 2주 뒤(통지일+15일) 대기 → 자동매수 (4주 유예 없음)
            휴일이면 익영업일 적용
...
NOTICE_DELAY_DAYS_EXISTING = 29   # 기존가입자: 만기일 + 4주 뒤(원문 수정: 만기일 + 29일)
WAIT_DAYS_AFTER_NOTICE = 15       # 통지 후 2주 뒤(원문 수정: 통지일 + 15일, 기존/신규 공통)
